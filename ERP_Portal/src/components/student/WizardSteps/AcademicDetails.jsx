    ...
    <form onSubmit={(e) => { e.preventDefault(); onNext(); }} className="space-y-8 animate-in fade-in slide-in-from-bottom-2 duration-300">
      <div className="bg-white p-6 rounded-lg border border-gray-100 shadow-sm">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div>
            ...
            <input name="tenthYear" type="text" required className={inputStyle} value={data.tenthYear || ''} onChange={handleChange} placeholder="2021" />
          </div>
          <div className="grid grid-cols-2 gap-4 md:col-span-2">
            <div>
              <label className={labelStyle}>Total Marks</label>
              <input name="tenthTotalMarks" type="number" required className={inputStyle} value={data.tenthTotalMarks || ''} onChange={handleChange} placeholder="500" />
            </div>
            <div>
              <label className={labelStyle}>Marks Obtained</label>
              <input name="tenthMarks" type="number" required className={inputStyle} value={data.tenthMarks || ''} onChange={handleChange} placeholder="315" />
            </div>
          </div>
          <div>
            <label className={labelStyle}>Percentage (%)</label>
            <input name="tenthPercentage" type="number" step="0.01" required className={inputStyle} value={data.tenthPercentage || ''} onChange={handleChange} placeholder="56.6" />
          </div>
        </div>
      </div>
      ...
      <div className="bg-white p-6 rounded-lg border border-gray-100 shadow-sm">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div>
            <label className={labelStyle}>Passing Year</label>
            <input name="twelfthYear" type="text" required className={inputStyle} value={data.twelfthYear || ''} onChange={handleChange} placeholder="2023" />
          </div>
          <div className="grid grid-cols-2 gap-4 md:col-span-2">
            <div>
              <label className={labelStyle}>Total Marks</label>
              <input name="twelfthTotalMarks" type="number" required className={inputStyle} value={data.twelfthTotalMarks || ''} onChange={handleChange} placeholder="500" />
            </div>
            <div>
              <label className={labelStyle}>Marks Obtained</label>
              <input name="twelfthMarks" type="number" required className={inputStyle} value={data.twelfthMarks || ''} onChange={handleChange} placeholder="315" />
            </div>
          </div>
          <div>
            <label className={labelStyle}>Percentage (%)</label>
            <input name="twelfthPercentage" type="number" step="0.01" required className={inputStyle} value={data.twelfthPercentage || ''} onChange={handleChange} placeholder="63.00" />
          </div>
        </div>
