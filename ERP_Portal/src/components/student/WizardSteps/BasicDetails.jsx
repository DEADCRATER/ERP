      ...
      <div className="bg-white p-6 rounded-lg border border-gray-100 shadow-sm">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            ...
            <input name="name" type="text" required className={inputStyle} value={data.name || ''} onChange={handleChange} placeholder="Full Name" />
          </div>
          <div>
            <label className={labelStyle}>Father's Name</label>
            <input name="fatherName" type="text" required className={inputStyle} value={data.fatherName || ''} onChange={handleChange} placeholder="Father's Name" />
          </div>
          <div>
            <label className={labelStyle}>Mother's Name</label>
            <input name="motherName" type="text" required className={inputStyle} value={data.motherName || ''} onChange={handleChange} placeholder="Mother's Name" />
          </div>
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            ...
            <div>
              ...
              <input name="district" type="text" required className={inputStyle} value={data.district || ''} onChange={handleChange} placeholder="Madhubani" />
            </div>
            <div>
              <label className={labelStyle}>Pin Code</label>
              <input name="pinCode" type="text" required className={inputStyle} value={data.pinCode || ''} onChange={handleChange} placeholder="Pin Code" />
            </div>
            <div>
              <label className={labelStyle}>Country</label>
              <input name="country" type="text" required className={inputStyle} value={data.country || 'India'} onChange={handleChange} />
            </div>
          </div>
        </div>
      </div>
