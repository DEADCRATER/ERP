...
const StudentStatusView = ({ student, onUpdateNow, onDownload }) => {
  ...
  return (
    <div className="min-h-screen bg-white font-sans text-gray-800 pb-12 animate-in fade-in duration-500">
      ...
      <div
        className={`${primaryColor} text-white px-6 py-3 flex flex-col md:flex-row justify-between items-center max-w-7xl mx-auto mt-4 shadow-md`}
      >
        <div className="font-bold tracking-wide">
          Enrollment ID:{" "}
          <span className="font-black text-yellow-300">
            {enrollmentNumber || applicationNumber || "N/A"}
          </span>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto mt-6 px-4">
        <div
          className={`${secondaryColor} border ${borderColor} rounded-lg px-6 py-4 flex items-center gap-3 shadow-sm`}
        >
          <svg
            className="w-6 h-6 text-[#6A4B9F]"
            fill="currentColor"
            viewBox="0 0 20 20"
          >
        ...
        <div className="border border-gray-200 rounded-xl overflow-hidden shadow-2xl">
          ...
          <div className="p-8 bg-gray-50/30">
            <div className="grid grid-cols-1 gap-px bg-gray-200 border border-gray-200 rounded-lg overflow-hidden">
              <div className="grid grid-cols-3 bg-white">
                <div className="p-4 bg-gray-50 font-bold text-gray-500 uppercase text-[11px] tracking-widest border-r">
                  Enrollment Id
                </div>
                <div className="p-4 col-span-2 font-black text-[#2D1B69]">
                  {enrollmentNumber ||
                    applicationNumber ||
                    "PENDING GENERATION"}
                </div>
              ...
              <div className="grid grid-cols-3 bg-white">
                ...
                <div className="p-4 col-span-2 font-black text-[#2D1B69] uppercase">
                  {name}
                </div>
              </div>
              <div className="grid grid-cols-3 bg-white">
                ...
                <div className="p-4 col-span-2">
                  ...
                  <p className="mt-3 text-xs font-bold text-gray-400 italic">
                    Your BUHS-{student.regNo?.slice(-4) || "2026"} registration
            ...
            <div className="mt-10 flex flex-col md:flex-row justify-end items-center gap-4">
              <button
                onClick={() =>
                  window.open(
                    `/principal/student-details/${_id || student.regNo}`,
                    "_blank",
                  )
                }
          ...
          <div className="bg-gray-100 px-8 py-4 flex justify-end">
            <span className="text-[10px] font-black text-gray-400 italic">
              Digital FingerPrint: a30b4faa3d68b57251d7e4bb69ccc0a1
            </span>
          </div>
        </div>
      </main>
      ...
      <footer className="mt-20 text-center text-[10px] font-black text-gray-400 uppercase tracking-[0.3em]">
        Organized by BUHS Patna &copy; 2026 
        {student.regNo?.slice(-4) || "99XY"}
      </footer>
    </div>
  );
};
